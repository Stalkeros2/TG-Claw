...
/obj/item/clothing/suit/hooded/explorer
	...
	armor = list("melee" = 35, "bullet" = 30, "laser" = 25, "energy" = 20, "bomb" = 40, "bio" = 50, "rad" = 40, "fire" = 50, "acid" = 50)
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals, /obj/item/resonator, /obj/item/mining_scanner, /obj/item/t_scanner/adv_mining_scanner, /obj/item/pickaxe, /obj/item/gun, /obj/item/ammo_box, /obj/item/ammo_casing)
...
/obj/item/clothing/mask/gas/explorer
	...
	armor = list("melee" = 10, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 0, "bio" = 50, "rad" = 20, "fire" = 20, "acid" = 40)
	resistance_flags = FIRE_PROOF
